...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/afs/cern.ch/work/a/aswain/CMSSW_9_4_0/src/egm_tnp_analysis/results/Fall17_SUSY/passingMiniIsoLoose/DY_madgraph_passingMiniIsoLoose.root')
