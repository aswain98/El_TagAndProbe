...
for sName in tnpSamples.Moriond19_10X.keys(): #.Data2018_102X.keys():    
    sample = tnpSamples.Moriond19_10X[sName] #.Data2018_102X[sName]
...
#    trees['rec'] = 'GsfElectronToSC'
    for tree in trees:
        dirout = '/afs/cern.ch/work/w/wiwong/TagAndProbe/CMSSW_10_2_5/src/egm_tnp_analysis/PUTree/' #'/eos/cms/store/group/phys_egamma/soffi/TnP/ntuples_20180920/2018Data_1/mc/PU/'
        mkdir(dirout)
